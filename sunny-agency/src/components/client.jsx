...
const Client = () => {
    ...
    function Client(props) {
        return (
            <div className='client' style={{backgroundColor:'transparent',display:'flex',flexDirection:'column',gap:'20px',justifyContent:'space-between',padding:'20px 0px'}}>
                ...
                <p style={{padding:'12px',fontFamily: 'Barlow', fontWeight: '600', fontSize: '18px', lineHeight: '32px', letterSpacing: '-0.13px', textAlign: 'center', color:'rgba(91, 99, 109, 1)'}}>{props.description}</p>
                <div>
                    <h1 style={{marginBottom:'10px',color:'rgba(36, 48, 62, 1)', fontFamily: 'Fraunces 9pt Soft', fontWeight: '900', fontSize: '18px', lineHeight: '100%', letterSpacing: '-0.13px', textAlign: 'center',}}>{props.name}</h1>
                    <short style={{color:'rgba(167, 170, 173, 1)', fontFamily: 'Barlow', fontWeight: '600', fontSize: '14px', lineHeight: '25px', letterSpacing: '-0.1px', textAlign: 'center',}}>{props.role}</short>
                </div>
            </div>
        )
    }
    ...
    return (
        <section className='clients' style={{backgroundColor:'white',display:'flex',flexDirection:'column',justifyContent:'center',alignItems: 'center',padding:'120px 100px',textAlign:'center'}}>
              <h1 style={{color:`rgba(167, 170, 173, 1)`,fontFamily: 'Fraunces 9pt Soft', fontWeight: '900', fontSize: '20px',lineHeight: '100%', letterSpacing: '5px', textAlign: 'center'}}>CLIENT TESTIMONIALS</h1>
